...
class ChaseObject(Node):
    def __init__(self):
        ...
        # ---- Tunable params ----
        self.declare_parameter('desired_distance', 0.2)     # meters
        self.declare_parameter('max_lin', 0)             # 0.15  m/s (Burger safe-ish) Starting with zero so we can fine tune angle PID first
